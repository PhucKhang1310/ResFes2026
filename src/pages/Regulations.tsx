import RadioAccordionItem from "../components/RadioAccordionItem";
    ...
    >
      <div className="mx-auto max-w-5xl">
        ...
        <div className="join join-vertical w-full rounded-2xl bg-white text-black shadow-xl">
          <RadioAccordionItem
            radioName="regulations-accordion"
          ...
          >
            <ul className="list-disc pl-5 space-y-2">
              <li>
                ...
                <strong>only one sub-committee</strong>. The Board of Reviewers
                will check for similarity and eligibility of all submissions.
              </li>
              <li>
              ...
              <li>
                ...
                <strong>ResFes 2026 mandatory format</strong>. Submissions that
                do not meet the requirements will be{" "}
              ...
              <div>
                ...
                <ul className="mt-3 list-disc pl-5 space-y-2">
                  ...
                  <li>
                    ...
                    <ul className="mt-2 list-disc pl-5 space-y-1">
                      <li>
                        IEEE style should be applied for Information Technology.
                      ...
                      <li>
                        APA style should be applied for Business Administration,
                        Linguistics, Multimedia Communication, and Digital Arts
                        &amp; Design. For more details, please visit{" "}
                        <a
                  ...
                  <li>
                    Research teams with the highest scores in each sub-committee
          ...
          <RadioAccordionItem
            radioName="regulations-accordion"
            title="4. Full Paper Submission Guidelines"
